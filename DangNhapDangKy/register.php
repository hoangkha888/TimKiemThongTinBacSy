...
<body>
    ...
    <div class="Content">
        <div class="formregister">
            ...
            <button type="submit" name="register1">Đăng ký</button>
            </form>
        </div>
    </div>
    <div class="footer">
        ...
        <div class="contact1">
            ...
            <img src="Image/2021 Doctor. All rights reserved..png">
        </div>
        <div class="contact1">
            <img src="Image/nhatduong146@gmail.com.png">
            <img src="Image/(+84) 935198555.png">
        </div>
    </div>
</body>
</html>